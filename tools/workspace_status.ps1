...
#
# Outputs key-value lines for Bazel stamping
$commit   = git rev-parse --short=12 HEAD
$ts       = git show -s --date=format:%Y%m%d%H%M%S --format=%cd HEAD
Write-Output "STABLE_GIT_COMMIT $commit"
Write-Output "STABLE_GIT_COMMIT_TIME $ts"
